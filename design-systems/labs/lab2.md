...
<div class="row">
  <div class="col-lg-12">
    <ul class="list-unstyled">
      <li class="float-end">
        <button type="button" class="btn btn-outline-primary" onclick="window.location.href='##Лабораторная работа №2: Проектирование логической модели базы данных';">Вверх</button>
      </li>
      <li  class="float-end">
